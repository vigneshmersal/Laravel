    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.candidates.update", [$candidate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" type="text" name="text" id="text" value="{{ old('text', $candidate->text) }}" required>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('textarea') ? 'is-invalid' : '' }}" name="textarea" id="textarea">{!! old('textarea', $candidate->textarea) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Candidate::RADIO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('radio') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="radio_{{ $key }}" name="radio" value="{{ $key }}" {{ old('radio', $candidate->radio) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('select') ? 'is-invalid' : '' }}" name="select" id="select">
                    ...
                    @foreach(App\Candidate::SELECT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('select', $candidate->select) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('checkbox') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="checkbox" id="checkbox" value="1" {{ $candidate->checkbox || old('checkbox', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('integer') ? 'is-invalid' : '' }}" type="number" name="integer" id="integer" value="{{ old('integer', $candidate->integer) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('float') ? 'is-invalid' : '' }}" type="number" name="float" id="float" value="{{ old('float', $candidate->float) }}" step="0.01" min="1" max="100">
                @if($errors->has('float'))
                    <div class="invalid-feedback">
                        {{ $errors->first('float') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('money') ? 'is-invalid' : '' }}" type="number" name="money" id="money" value="{{ old('money', $candidate->money) }}" step="0.01">
                @if($errors->has('money'))
                    <div class="invalid-feedback">
                        {{ $errors->first('money') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $candidate->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_time') ? 'is-invalid' : '' }}" type="text" name="date_time" id="date_time" value="{{ old('date_time', $candidate->date_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time') ? 'is-invalid' : '' }}" type="text" name="time" id="time" value="{{ old('time', $candidate->time) }}">
                @if($errors->has('time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('time') }}
                    </div>
